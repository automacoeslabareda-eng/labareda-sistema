/**
 * ============================================================
 *  admin-api  (Netlify Function) — camada SEGURA do painel
 * ============================================================
 *  O painel admin (labareda-ecommerce) NAO acessa mais dados sensiveis
 *  (pedidos, clientes, mensagens, reservas) direto com a chave publica.
 *  Ele chama esta funcao, que:
